...
class HealthFearView: UIView {
    ...
    func updateImages() {
        if isFear == nil {
            leftDataImageView.image = UIImage(named: "healthTrueOff")
            rightDataImageView.image = UIImage(named: "healthFalseOff")
        } else if let isFear = isFear  {
            leftDataImageView.image = isFear ? UIImage(named: "healthTrueOn") : UIImage(named: "healthTrueOff")
            rightDataImageView.image = isFear ? UIImage(named: "healthFalseOff") : UIImage(named: "healthFalseOn")
    ...
    private func setTitleLabel() {
        ...
        titleLabel.text = CommonString.healthTitle
    }
    ...
    private func setSubtitleLabel() {
        ...
        subtitleLabel.text = CommonString.healthSubtitle
    }
...
//            make.top.equalTo(rightDataImageView.snp.bottom).offset(191)
        ...
        furtherButtonView.buttonAction = {
            self.didPressedFurther?(self.isFear ?? false)
        }
    }
