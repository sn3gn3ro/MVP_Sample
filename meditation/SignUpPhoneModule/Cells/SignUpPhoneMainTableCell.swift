//
//  SignUpPhoneMainTableCell.swift
//  meditation
//
...
protocol SignUpPhoneMainTableCellDelegate: AnyObject {
...
class SignUpPhoneMainTableCell: UITableViewCell {
    ...
    weak var delegate: SignUpPhoneMainTableCellDelegate?
